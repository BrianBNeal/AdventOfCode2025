...
List<Problem> problems = [
 ...
 //   new DayFour(useTestData), new DayFour(),      /* 0:08 (with Dict), originally 10+min due to inefficient way of find adjacent spaces, then 3:57 (Lists and a single for loop)*/
	//new DayFive(useTestData), new DayFive(),      /* 0:01 */
	//new DaySix(useTestData), new DaySix(),        /* 0:01 */
	//new DaySeven(useTestData), new DaySeven(),    /* 0:01 */
	/*new DayEight(useTestData),*/ new DayEight(),    /* 0:01 */
